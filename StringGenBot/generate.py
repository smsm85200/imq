...
ask_ques = " **• قـم بأخـتيار نو؏ الجلسة الان  🕹** \n\n**✓**"
buttons_ques = [
    [
        InlineKeyboardButton("‹ بـايـࢪوجـࢪام ›", callback_data="pyrogram1"),
        InlineKeyboardButton("‹ تـلـثـيون ›", callback_data="telethon"),
    ],
    [
        InlineKeyboardButton("‹ V2 بايروجرام   ›", callback_data="pyrogram"),
    ],
    [
